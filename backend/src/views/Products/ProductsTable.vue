<template>
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
      <div class="flex justify-between border-b-2 pb-3">
        <div class="flex items-center">
          ...
          <span v-if="products && products.total" class="ml-3">Found {{products.total}} products</span>
        </div>
        <div>
  ...
  import {EllipsisHorizontalCircleIcon , PencilIcon, TrashIcon} from '@heroicons/vue/24/outline'
